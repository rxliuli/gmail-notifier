...
const ProjectName = 'Gmail Notifier'
...
await $`xcrun safari-web-extension-converter --macos-only --bundle-identifier com.rxliuli.gmail-notifier --force --project-location .output .output/safari-mv3`
